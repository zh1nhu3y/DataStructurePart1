...
int main()
{
    ...
    // Huey File path
    std::string inputFile = "C:/Users/Zhin Huey/OneDrive - Asia Pacific University/Degree Year2-SEM2/Data Structure/Assignement 1/test_tripadvisor_hotel_reviews.csv";
