        ...
        switch (subchoice) {
            ...
            case 3: {
                ...
                if (low != nullptr && high != nullptr) {
                    ...
                    operations.bubbleSortArray(reviews);  // Assuming you have a bubbleSort method in operations
                    auto cstop = high_resolution_clock::now();
                    duration<double> cduration = duration_cast<microseconds>(cstop - cstart);
                    cout << "Array Bubble Sort Time: " << cduration.count() << " microseconds" << endl;

                    SentimentNode* bubbleHead = sentimentList.getHead();
                    if (bubbleHead != nullptr) {
                        auto dstart = high_resolution_clock::now();
                        sentimentList.bubbleSortSentiment();  // Assuming you have a bubbleSort method in SentimentList class
    ...
    do {
        ...
        switch (choice) {
            ...
            case 6:
            {
                ...
                duration<double> eduration = duration_cast<milliseconds>(eend - estart) / 1000;
                cout << "Comparison Done!" << endl;
                cout << "Comparison Time: " << eduration.count() << " seconds" << endl;
            ...
            case 7:
            {
                ...
                std::chrono::duration<double> grduration = duration_cast<milliseconds>(gend - gstart) / 1000;
                cout << "Report Generated!" << endl;
                cout << "Generating Report Time: " << grduration.count() << " seconds" << endl;
                break;
            }
            case 0:{
